...
class AllureReporter:
    ...
    def _create_labels(
        self, test_name: str, custom_labels: List[Dict[str, str]] = None
    ) -> List[Dict[str, str]]:
    ...
    def _create_attachments(
        self, attachments: List[str], screenshot_path: str = None
    ) -> List[Dict[str, str]]:
    ...
    def _create_status_details(
        self, status: str, error_message: str = None
    ) -> Dict[str, Any]:
        """Create Allure status details"""
        if status.upper() == "FAILED" and error_message:
            return {"message": error_message, "trace": error_message}
        elif status.upper() == "SKIPPED":
            return {"message": "Test was skipped", "trace": None}
        else:
            return {}
    ...
    def finalize_report(self):
        ...
        print(
            "To generate Allure report, run: allure generate allure-results --clean -o allure-report"
        )
