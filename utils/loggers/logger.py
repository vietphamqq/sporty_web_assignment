...
class Logger:
    ...
    @classmethod
    def log_test_step(cls, logger: logging.Logger, step: str, details: Optional[dict] = None):
    ...
    @classmethod
    def log_assertion(cls, logger: logging.Logger, assertion: str, result: bool, details: Optional[str] = None):
