...
class DriverManager:
    ...
    @classmethod
    def get_mobile_driver(cls, worker_id: Optional[str] = None, device: Optional[str] = None) -> webdriver.Chrome:
    ...
    def _cleanup_worker(cls, worker_key: str) -> None:
        ...
        if worker_key in cls._drivers:
            try:
                ...
                print(f"Warning: Error quitting mobile driver for worker '{worker_key}': {e}")
            finally:
