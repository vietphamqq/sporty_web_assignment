...
class TestBase(ABC):
    ...
    def _setup_reporters(self):
        ...
        self.allure_reporter = AllureReporter() if Settings.REPORT.allure_report else None
    ...
    def teardown_method(self):
        ...
        self.logger.info(f"Test completed: {self.__class__.__name__} in {duration:.2f}s")
